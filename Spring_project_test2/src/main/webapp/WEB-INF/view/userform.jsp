...
<body>
	...
	<sform:form method="post" action="${user }" modelAttribute="userInfo">
		<fieldset>
			...
			<sform:label path="id" class="title_label">이름</sform:label>
			<sform:input path="id" />
			<br>
			...
			<br>
			<sform:label path="cellphone" class="title_label">휴대전화</sform:label>
			<sform:input path="cellphone" />
			<br>
